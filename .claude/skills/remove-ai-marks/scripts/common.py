...
MAX_INPUT_BYTES = int(os.environ.get("CLAUDE_WM_MAX_INPUT_BYTES", str(256 << 20)))
MAX_STDIN_BYTES = int(os.environ.get("CLAUDE_WM_MAX_STDIN_BYTES", str(64 << 20)))
...
_CHILD_RLIMIT_AS = int(os.environ.get("CLAUDE_WM_CHILD_RLIMIT_AS", str(4 << 30)))
_CHILD_RLIMIT_FSIZE = int(os.environ.get("CLAUDE_WM_CHILD_RLIMIT_FSIZE", str(2 << 30)))
